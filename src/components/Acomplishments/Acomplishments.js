...
const data = [
  { number: 20,
    ...
    certi_img:'https://github.com/Sakshiwalode28/sakshiwalode_portfolio/blob/main/public/images/lco.png?raw=true',
    image_link :"https://s3-ap-southeast-1.amazonaws.com/learnyst/schools/2410/certificates/53635/2972046_53635.pdf?1662885995"},
  { number: 20,
    name: 'Complete ReactJS developer Bootcamp',
    by:'Coursera',   
    certi_img:'https://github.com/Sakshiwalode28/sakshiwalode_portfolio/blob/main/public/images/coursera.png?raw=true',
    image_link:"https://www.coursera.org/account/accomplishments/verify/Z9FSUUFEE92L"},
  
    { number: 20,
    name: 'Web Development Bootcamp',
    by:'Codekaro',
    certi_img:'https://github.com/Sakshiwalode28/sakshiwalode_portfolio/blob/main/public/images/codekaro.png?raw=true',
